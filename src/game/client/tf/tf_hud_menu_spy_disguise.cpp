...
void CHudMenuSpyDisguise::ApplySchemeSettings( IScheme *pScheme )
{
	...
	if ( b360Style )
	{
		...
		m_pClassItems_Red[8]->LoadControlSettings( VarArgs( "%s/civilian_red.res", res_dir ) );
		...
		m_pClassItems_Blue[8]->LoadControlSettings( VarArgs( "%s/civilian_blue.res", res_dir ) );
	...
	else
	{
		...
		m_pClassItems_Red[8]->LoadControlSettings( "resource/UI/disguise_menu/civilian_red.res" );
		...
		m_pClassItems_Blue[8]->LoadControlSettings( "resource/UI/disguise_menu/civilian_blue.res" );
